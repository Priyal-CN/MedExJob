...
public class MedexjobBackendApplication {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("📊 Health Check: http://localhost:8082/api/actuator/health");
        System.out.println("🌐 Frontend is running on its own server (e.g., http://localhost:5173)");
    }
}
